...
On pushes to `main`, GitHub Actions runs CI, computes the next semantic version, updates `CHANGELOG.md`, tags the release, builds distributions, and publishes to PyPI.
